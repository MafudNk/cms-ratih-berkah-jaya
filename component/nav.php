<?php 
 ...
 $about = "http://localhost/alazea/pages/about.php";
 $shop = "http://localhost/alazea/pages/shop.php";
 $shop_details = "http://localhost/alazea/pages/shop-details.php";
 $portfolio = "http://localhost/alazea/pages/portfolio.php";
 $contact = "http://localhost/alazea/pages/contact.php";
?>
